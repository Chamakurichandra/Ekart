...
export default class CartDetails2 extends React.Component{
    constructor(){
        super();
        this.state={
            data:1,
    ...
    render(){
        return(
            ...
            <div className="col-4">
            <div>
            <img className="images" src="https://i.postimg.cc/2yjbPcSd/Childrens.jpg" width="100%" height="100px" alt=""/>
            </div>
            <div>
            ...
            <div className="col-4">
            <b>Girls Midi/Knee Length Casual Dress(Red,Sleevless)</b>
