...
export default class CartDetails3 extends React.Component{
    constructor(){
        super();
        this.state={
            data:1,
    ...
    render(){
        return(
            ...
            <div className="col-4">
            <div>
            <img className="images" src="https://i.postimg.cc/SNJjCz2K/men.jpg" width="100%" height="100px" alt=""/>
            </div>
            <div>
            ...
            <div className="col-4">
            <b>Men Solid Casual Spread Shirt(Black)</b>
