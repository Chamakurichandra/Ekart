...
export default class CartDetails9 extends React.Component{
    constructor(){
        super();
        this.state={
            data:1,
    ...
    render(){
        return(
            ...
            <div className="col-4">
            <div>
            <img className="images" src="https://i.postimg.cc/vTXqsNLG/ac.jpg" width="100%" height="100px" alt=""/>
            </div>
            <div>
            ...
            <div className="col-4">
            <b>Samsung 1.5 Ton 5 Star Split Triple Inverter Dura Series AC - White  (AR18TV5HLTUNNA/AR18TV5HLTUXNA, Alloy Condenser)</b>
