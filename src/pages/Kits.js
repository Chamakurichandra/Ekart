    ...
    render(){
     ...
     <div>
        ...
        <div className="same-all">
            ...
            <div className="col">
               <div>
                 <img className="images" src="https://i.postimg.cc/KYX5dbSn/babykit.jpg" width="80%" height="500px" alt=""/>
               </div>
               <div>
            ...
            <div className="col">
                ...
                <h5>Firststep Cotton Baby Bed Protecting Mat  (Red)</h5>
