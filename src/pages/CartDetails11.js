...
export default class CartDetails11 extends React.Component{
    constructor(){
        super();
        this.state={
            data:1,
    ...
    render(){
        return(
            ...
            <div className="col-4">
            <div>
            <img className="images" src="https://i.postimg.cc/RVNQhhv7/headphone.jpg" width="100%" height="100px" alt=""/>
            </div>
            <div>
            ...
            <div className="col-4">
            <b>boAt Rockerz 450 Bluetooth Headset  (Luscious Black, Wireless over the head)</b>
