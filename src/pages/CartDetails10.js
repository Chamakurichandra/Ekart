...
export default class CartDetails10 extends React.Component{
    constructor(){
        super();
        this.state={
            data:1,
    ...
    render(){
        return(
            ...
            <div className="col-4">
            <div>
            <img className="images" src="https://i.postimg.cc/KYX5dbSn/babykit.jpg" width="100%" height="100px" alt=""/>
            </div>
            <div>
            ...
            <div className="col-4">
            <b>Firststep Cotton Baby Bed Protecting Mat  (Red)</b>
            <h5> &#8377;300/-<small className="strike"> &#8377;420/-</small></h5>
