...
export default class CartDetails6 extends React.Component{
    constructor(){
        super();
        this.state={
            data:1,
    ...
    render(){
        return(
            ...
            <div className="col-4">
            <div>
            <img className="images" src="https://i.postimg.cc/6p6Knk1f/realme.jpg" width="100%" height="100px" alt=""/>
            </div>
            <div>
            ...
            <div className="col-4">
            <b>Realme 3 Pro(Nitro Blue,64GB)(4 GB RAM)</b>
